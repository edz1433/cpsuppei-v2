    ...
    <div class="col-12 col-md-6 col-lg-4">
        <div class="card shadow ">
            <div class="card-body">
                ...
                <form action="{{ route('repairCreate') }}" id="form-control" method="POST">
                    @csrf
                    <!-- Property -->
                    ...
                    <div class="col-12 mb-2">
                        <label class="form-label">
                            <span class="badge badge-secondary">Findings</span>
                        </label>
                        <textarea name="findings" class="form-control form-control-sm" rows="3"></textarea>
                    </div>
                
                    <div class="col-12">
                        <label for="urgency" class="form-label">
                            <span class="badge badge-secondary">Urgency</span>
                        </label>
                        <select name="urgency" id="urgency" class="select1 form-control form-control-sm">
